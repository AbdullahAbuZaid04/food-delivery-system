...
function EmptyState({
  ...
  description = "جرّب تفرّج على فئة تانية أو غيّر كلمة البحث — أكيد رح نلاقيلك أكلة بتجنّن.",
  ...
  return (
    <div className="mt-10 md:mt-12 min-h-[320px] flex flex-col items-center justify-center rounded-[24px] border border-dashed border-clay/25 bg-cream-deep/60 px-6 py-14 text-center">
      ...
      <p className="text-cocoa-soft text-[14.5px] mt-2 leading-relaxed max-w-md">
        {description}
      </p>
      <button
        type="button"
